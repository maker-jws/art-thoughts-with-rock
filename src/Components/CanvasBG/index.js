...
class CanvasBG extends Component {
  ...
  paintBG() {
    ...
    const grd = ctx.createRadialGradient(
      this.props.winWidth / 2,
      this.props.winHeight,
      10,
      this.props.winWidth / 4,
      this.props.winHeight,
      this.props.winWidth
    );
  ...
  componentDidUpdate() {
    ...
    if (
      this.state.winHeight !== this.props.winHeight ||
      this.state.winWidth !== this.props.winWidth
    ) {
      this.setState(
        {
  ...
  render() {
    ...
    return (
      <div>
        <canvas
          className="Canvas-BG-graphic"
          ref="graphic"
          width={width}
          height={height}
        />
        <canvas
          className="Canvas-BG-grad"
          ref="canvas"
          width={winWidth}
          height={winHeight}
        />
